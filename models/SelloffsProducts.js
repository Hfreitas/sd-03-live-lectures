const createSelloffsProducts = (sequelize, DataTypes) => {
  const SelloffProducts = sequelize.define('SelloffProducts', {}, { timestamps: false });
...
module.exports = createSelloffsProducts;